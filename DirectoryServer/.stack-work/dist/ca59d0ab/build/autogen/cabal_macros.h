...
/* package DirectoryServer-0.1.0.0 */
#define VERSION_DirectoryServer "0.1.0.0"
#define MIN_VERSION_DirectoryServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package MyApis-0.1.0.0 */
#define VERSION_MyApis "0.1.0.0"
#define MIN_VERSION_MyApis(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "DirectoryServer-0.1.0.0-3u9k9prEiyPD0b34DuVRKW"

#define CURRENT_PACKAGE_KEY "DirectoryServer-0.1.0.0-3u9k9prEiyPD0b34DuVRKW"
